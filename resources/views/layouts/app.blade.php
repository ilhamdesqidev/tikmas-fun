...
<body class="font-poppins bg-gray-50">
    ...
    <aside id="sidebar" class="fixed left-0 top-0 w-64 h-screen bg-sidebar text-white sidebar-transition sidebar-mobile md:translate-x-0 z-50 overflow-y-auto">
        ...
        <nav class="mt-6 pb-6">
            ...
            <ul class="space-y-1 px-2">
               ...
               <li>
                    <a href="{{ route('admin.voucher.index') }}" class="nav-link flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-sidebar-hover hover:text-white transition-all duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                        </svg>
                        Voucher
                    </a>
                </li>
            ...
            <!-- Logout Button (Moved to be right after Reports) -->
            <div class="px-4 pt-6 pb-2">
