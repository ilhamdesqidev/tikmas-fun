...
<body class="bg-gray-50">
    <!-- Header - Responsive -->
    <header class="bg-white border-b border-black sticky top-0 z-40">
        <div class="container mx-auto px-3 sm:px-4 py-3 sm:py-5">
            ...
            <div class="sm:hidden">
                ...
                <div class="text-center">
                    <h1 class="text-xl font-bold text-gray-800">Voucher & Promo</h1>
                    <p class="text-xs text-gray-600 mt-0.5">Dapatkan penawaran terbaik untuk Anda</p>
                </div>
            </div>
