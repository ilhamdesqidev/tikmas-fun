...
@section('page-description', 'Edit fasilitas yang sudah ada')
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" required
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                    placeholder="Masukkan deskripsi wahana">{{ old('description', $facility->description) }}</textarea>
                @error('description')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <img src="{{ $facility->image_url }}" alt="{{ $facility->name }}" class="w-full h-64 object-cover rounded-lg border border-gray-200">
                </div>
            </div>
