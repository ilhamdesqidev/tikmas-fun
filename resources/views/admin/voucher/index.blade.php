    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Syarat & Ketentuan</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <!-- KOLOM BARU SYARAT & KETENTUAN -->
                <td class="px-4 py-4">
                    <button onclick='openSyaratKetentuanModal(@json($voucher->name), @json($voucher->syarat_ketentuan))' 
                            class="inline-flex items-center gap-1 px-3 py-1.5 bg-purple-100 text-purple-700 text-xs font-semibold rounded-lg hover:bg-purple-200 transition-colors">
            ...
            @endforelse
                ...
                <!-- MODAL BARU: Syarat & Ketentuan -->
<div id="syaratKetentuanModal" class="hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50 p-4">
    <div class="relative top-20 mx-auto w-full max-w-2xl">
        <div class="bg-white rounded-xl shadow-2xl">
            <div class="border-b border-gray-200 px-6 py-4 rounded-t-xl bg-gradient-to-r from-purple-500 to-purple-600">
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-purple-100" id="syaratKetentuanVoucherName"></p>
                        </div>
                    </div>
                    <button type="button" onclick="closeSyaratKetentuanModal()" class="text-white hover:text-purple-100 transition-colors">
            ...
            <div class="px-6 py-6">
                <div class="bg-purple-50 rounded-lg p-5 border-2 border-purple-200">
                    <ul class="space-y-3" id="syaratKetentuanList">
                ...
                <div class="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div class="flex items-start gap-2">
                        ...
                        <p class="text-sm text-blue-800">
                            <strong>Catatan:</strong> Syarat & ketentuan ini akan ditampilkan kepada user saat mereka melihat detail voucher.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 rounded-b-xl">
                <div class="flex justify-end">
                    <button type="button" onclick="closeSyaratKetentuanModal()" class="px-5 py-2.5 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium shadow-sm">
                        Tutup
                    </button>
                </div>
            </div>
...
function openSyaratKetentuanModal(voucherName, syaratKetentuan) {
    document.getElementById('syaratKetentuanModal').classList.remove('hidden');
    document.body.style.overflow = 'hidden';
    
    // Set voucher name
    document.getElementById('syaratKetentuanVoucherName').textContent = voucherName;
    
    // Parse syarat ketentuan
    const listElement = document.getElementById('syaratKetentuanList');
    listElement.innerHTML = '';
    
    if (!syaratKetentuan || syaratKetentuan.trim() === '') {
        ...
        const syaratArray = syaratKetentuan.split('\n')
            .map(s => s.trim())
            .filter(s => s.length > 0);
        
        if (syaratArray.length === 0) {
            listElement.innerHTML = '<li class="text-gray-500 text-sm italic">Tidak ada syarat & ketentuan</li>';
        } else {
            syaratArray.forEach(syarat => {
                ...
                li.innerHTML = `
                    ...
                    <span class="text-sm">${escapeHtml(syarat)}</span>
                `;
                listElement.appendChild(li);
            });
        }
...
function closeSyaratKetentuanModal() {
    document.getElementById('syaratKetentuanModal').classList.add('hidden');
    document.body.style.overflow = 'auto';
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ['createVoucherModal','editVoucherModal','descriptionModal','deleteModal','syaratKetentuanModal'].forEach(id => {
        ...
        if (el) {
            el.addEventListener('click', function(e) {
                if (e.target === this) {
                    ...
                    if (id === 'syaratKetentuanModal') closeSyaratKetentuanModal();
                }
            });
        }
    });
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape') {
            if (!document.getElementById('createVoucherModal').classList.contains('hidden')) {
                ...
                closeImageModal();
            } else if (!document.getElementById('syaratKetentuanModal').classList.contains('hidden')) {
                closeSyaratKetentuanModal();
            }
        }
    });
});
