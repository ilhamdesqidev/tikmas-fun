                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-600">File Excel dengan format tabel profesional & styling otomatis</p>
                            </div>
                        </div>
                        <span class="bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow">PREMIUM</span>
                    </div>
                    ...
                    <div class="mt-4 p-3 bg-white bg-opacity-70 rounded-lg border border-green-300">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-gray-700">
                                <span class="font-semibold">Format Professional Excel:</span>
                                <ul class="mt-1 ml-4 list-disc text-xs space-y-1">
                                    <li>Tabel dengan border & styling profesional</li>
                                    <li>Header berwarna dengan freeze panes</li>
                                    <li>Status berwarna otomatis (Hijau/Abu/Merah)</li>
                                    <li>Auto-filter & formatting siap pakai</li>
                                    <li>Ringkasan statistik di bawah tabel</li>
                                </ul>
                            </div>
                        </div>
                    </div>
