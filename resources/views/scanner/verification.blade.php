...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6 sm:mb-8">
            <div class="w-16 h-16 sm:w-20 sm:h-20 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">MestaKara Scanner</h1>
            <p class="text-sm sm:text-base text-white text-opacity-90">Sistem Scanner Tiket</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 sm:p-8">
            <div class="text-center mb-4 sm:mb-6">
                ...
                <h2 class="text-lg sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2">Verifikasi Petugas</h2>
                <p class="text-gray-600 text-xs sm:text-sm">Masukkan kode petugas untuk mengakses dashboard scanner</p>
            </div>

            <!-- Alert Messages -->
            @if(session('success'))
                <div class="bg-green-50 border border-green-200 text-green-800 px-3 py-2 sm:px-4 sm:py-3 rounded-lg mb-4 text-sm">
            ...
            @if(session('error'))
                <div class="bg-red-50 border border-red-200 text-red-800 px-3 py-2 sm:px-4 sm:py-3 rounded-lg mb-4">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form action="{{ route('scanner.verify') }}" method="POST" id="verificationForm">
                ...
                <div class="mb-4 sm:mb-6">
                    <label for="staff_code" class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">
                        Kode Petugas
                    </label>
                    <input 
                        type="text" 
                        id="staff_code" 
                        name="staff_code"
                        class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-center text-base sm:text-lg font-mono tracking-widest uppercase"
                ...
                <button 
                    type="submit"
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 sm:py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 text-sm sm:text-base"
                    id="submitBtn"
                >
            ...
            <div class="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
                <div class="text-center">
                    <h3 class="text-xs sm:text-sm font-medium text-gray-900 mb-2">Petunjuk Penggunaan</h3>
                    <ul class="text-xs text-gray-600 text-left space-y-1 pl-4">
        ...
        <div class="mt-4 sm:mt-6 text-center">
            <div class="inline-flex items-center space-x-2 text-white text-opacity-90">
                ...
                <span class="text-xs sm:text-sm">Sistem Online</span>
            </div>
        </div>
    </div>
